...
export class SunburstChartComponent implements OnInit , OnChanges {
  ...
  ngOnInit() {
    console.log('service (oninitsun) color scheme: ' + this.regularChartsService.colorScheme);
    this.setColors();
    ...
    this.sunRadius = this.regularChartsService.sunRadius;
    this.hoverPieRadius = this.regularChartsService.sunRadius / this.sunDepth * 1.05;
  ...
  ngOnChanges() {
    console.log('service (onchangessun) color scheme: ' + this.regularChartsService.colorScheme);
    this.setColors();
    this.dataRefined = this.getRefinedData(this.data, 1);
    // console.log('data refined: ');
    // console.log(this.dataRefined);
